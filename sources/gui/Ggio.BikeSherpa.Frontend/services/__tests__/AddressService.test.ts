...
describe("AddressService.fetchAddress", () => {
    ...
    it("fetch with a 200 response returns a one Address array", async () => {
        ...
        expect(addressList[0].coordinates).toEqual({ longitude: 1, latitude: 2 });
    });
    ...
    it("fetch with a 200 response returns a multiple Address array", async () => {
        ...
        expect(data[0].coordinates).toEqual({ longitude: 1, latitude: 2 });
        expect(data[1].coordinates).toEqual({ longitude: 3, latitude: 4 });
        expect(data[2].coordinates).toEqual({ longitude: 5, latitude: 6 });
