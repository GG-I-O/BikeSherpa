...
namespace Ggio.BikeSherpa.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260917130629_DomainTypeForAttachmentFiles")]
    partial class DomainTypeForAttachmentFiles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ggio.BikeSherpa.Backend.Infrastructure.Repositories.Parameter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "STACK_HOLDER_INFO",
                            Value = "{\"CompanyName\":\"Compagnie\",\"Email\":\"contact@company.com\",\"Phone\":\"phone\",\"Adresse\":\"address\",\"Label\":\"the company\"}"
                        });
                });
