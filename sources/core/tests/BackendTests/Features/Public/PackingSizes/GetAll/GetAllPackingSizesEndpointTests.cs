...
using Ggio.BikeSherpa.Backend.Features.Public.PackingSizes.GetAll;
using Ggio.BikeSherpa.Backend.Features.Public.PackingSizes.Model;
using JetBrains.Annotations;
using Mediator;
using Moq;

namespace BackendTests.Features.Public.PackingSizes.GetAll;

[UsedImplicitly]
public class GetAllPackingSizesWebApplicationFactory() : TestWebApplicationFactory();
