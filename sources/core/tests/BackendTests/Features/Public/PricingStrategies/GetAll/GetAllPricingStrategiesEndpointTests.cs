...
using Ggio.BikeSherpa.Backend.Features.Public.PricingStrategies.GetAll;
using Ggio.BikeSherpa.Backend.Features.Public.PricingStrategies.Model;
using JetBrains.Annotations;
using Mediator;
using Moq;

namespace BackendTests.Features.Public.PricingStrategies.GetAll;

[UsedImplicitly]
public class GetAllPricingStrategiesWebApplicationFactory() : TestWebApplicationFactory();
