...
public class SimpleDeliveryStrategyTests
{
    ...
    public void CalculatePrice_WhenDeliveryIsOnSameDayAsContractDate_AddsExtraCost()
    {
        ...
        // Act
        var result = sut.CalculateDeliveryPriceWithoutVat(startDate, contractDate, 1, 0, 0, 0, 0, DefaultPackingSize, DefaultUrgency, 0, 0, 0);
        ...
        int core, int border, int periphery, int outside, double expectedZoneCost)
    {
        ...
        // Act
        var result = sut.CalculateDeliveryPriceWithoutVat(startDate, contractDate, 1, core, border, periphery, outside, DefaultPackingSize, DefaultUrgency, 0, 0, 0);
    ...
    public void CalculatePrice_IncludesPackingSizePrice()
    {
        ...
        // Act
        var result = sut.CalculateDeliveryPriceWithoutVat(startDate, contractDate, 1, 0, 0, 0, 0, packingSize, DefaultUrgency, 0, 0, 0);
    ...
    public void CalculatePrice_IncludesUrgencyCoefficientTimesDistance()
    {
        ...
        // Act
        var result = sut.CalculateDeliveryPriceWithoutVat(startDate, contractDate, 1, 0, 0, 0, 0, DefaultPackingSize, urgency, 10.0, 0, 0);
    ...
    public void CalculatePrice_WithAllFactors_ReturnsCorrectTotal()
    {
        ...
        // Act
        var result = sut.CalculateDeliveryPriceWithoutVat(startDate, contractDate, 1, 1, 2, 1, 1, packingSize, urgency, 5.0, 0, 0);
