...
public class PatchDeliveryStepOrderEndpoint(IMediator mediator): Endpoint<PatchDeliveryRequest>
{
     public override void Configure()
     {
          Patch("/delivery/{deliveryId:guid}/step/{stepId:guid}/order");
     ...
     {
          var command = new PatchDeliveryStepOrderCommand(req);
